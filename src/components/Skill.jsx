...
export default function Skill() {
    ...
    const skills = {
        ...
        soft: [
            ...
            { name: "Time Management", prof: 85 },
            { name: "Adaptable", prof: 89 },
        ...
        <div className="min-h-screen w-full bg-gradient-to-r from-white to-gray-60 py-16">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex justify-center mb-12 space-x-4">
                    <button onClick={() => setSkill('technical')}
                    ...
                    ${skill == "technical"
                                ...
                                : "text-gray-600 hover:indigo-800"
                            }`}
                    >
                        Technical Skills
                    </button>
                    <button onClick={() => setSkill('soft')}
                        className={`px-6 py-3 rounded-lg text-semibold text-lg transition-all duration-200 
                    ${skill == "soft"
                                ? "bg-gradient-to-r from-indigo-700 to-purple-700 text-white shadow-lg"
                                : "text-gray-600 hover:indigo-800"
                        ...
                        <div key={index} className="bg-white p-6 rounded=lg shadow-md transition-shadow duration-300">
                            ...
                            <div className="space-y-2 ">
                                ...
                                <div className="h-2 bg-gray-200 rounded-full">
                                    <div className="h-full bg-gradient-to-r from-indigo-600 via-purple-600 to-teal-600 rounded-full transition-all duration-200"
